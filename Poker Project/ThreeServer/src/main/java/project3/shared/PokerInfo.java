...
//Information for each stage of the game
public class PokerInfo implements Serializable {
    private static final long serialVersionUID = 1L;

    //Message Types
    public static final int CONNECT = 1; //Initial connection
    ...
    public static final int DISCONNECT = 7; //Client closing app
    public static final int NEW_GAME = 8; //Fresh start request
